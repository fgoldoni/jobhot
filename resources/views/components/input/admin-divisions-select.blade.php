...
<div
    ...
    x-data="{
      ...
      open: @entangle('showDivisionDropdown'),

      searchDivision: @entangle('searchDivision'),
      ...
      updateSelectedDivision(id, name) {
        this.selected = id;
        this.searchDivision = name;
        this.open = false;
    ...
    <span x-text="open" class="sr-only"></span>
    <ul
        x-ref="results"
    ...
    <div wire:loading  wire:target="searchDivision" class="absolute top-12 z-10 max-h-60 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
