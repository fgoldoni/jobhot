<x-admin-layout>
    ...
    <div>
        <dl class="mt-5 grid grid-cols-1 gap-5 lg:grid-cols-2 xl:grid-cols-3">
            @livewire('admin.dashboard.companies')

            @livewire('admin.dashboard.users')

            @livewire('admin.dashboard.jobs')
    ...
    <section>
        <div class="mt-8 max-w-7xl mx-auto pb-12">
            <div class="mt-1 grid grid-cols-1 gap-4 sm:grid-cols-2">
                <div class="relative bg-white px-4 py-5 shadow sm:rounded-lg sm:px-6">
                ...
                <div class="bg-white">
                    ...
                    <ul role="list" class=" px-6 py-5 divide-y divide-gray-200">
                        <li class="py-4">
                            <div class="flex space-x-3">
